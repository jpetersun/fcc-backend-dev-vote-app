...
var UserPoll = __webpack_require__(435);
...
var Account = function (_React$Component) {
  ...
  _createClass(Account, [{
    ...
    value: function componentDidMount() {
      ...
      axios.get('/account-details').then(function (response) {
        _this2.setState({ userData: response.data });
    ...
    value: function componentDidUpdate() {
      ...
      axios.get('/account-details').then(function (response) {
        _this3.setState({ userData: response.data });
      }).catch(function (error) {
        console.error('axios error', error);
      });
    }
    ...
    value: function render() {
      ...
      var polls = [];
      this.state.userData.polls.forEach(function (poll) {
        poll.userId = _this4.state.userData._id;
        polls.push(poll);
      });
