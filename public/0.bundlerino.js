...
var PollOption = __webpack_require__(274);
...
var Details = function (_React$Component) {
  ...
  _createClass(Details, [{
    ...
    value: function componentDidMount() {
      ...
      axios.get('/polls/' + this.props.params.id).then(function (response) {
        var firstOption = response.data.options[0].name;
        _this2.setState({ pollData: response.data, value: firstOption });
      }).catch(function (error) {
        console.error('axios error', error);
      });
    }
    ...
    value: function render() {
      return React.createElement(
        'form',
        { onSubmit: this.handleSubmit, method: 'post', action: '/poll-results' },
        React.createElement(
          'label',
          null,
          React.createElement(
...
var React = __webpack_require__(5);
var PollOption = function PollOption(props) {
  // console.log(props)
  return React.createElement(
    'option',
    { value: props.name, name: props.name },
    props.name
  );
};
...
if("function"=='function'&&_typeof(__webpack_require__(272))=='object'&&__webpack_require__(272)){// Expose Lodash on the global object to prevent errors when Lodash is
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(276), __webpack_require__(113)(module)))
