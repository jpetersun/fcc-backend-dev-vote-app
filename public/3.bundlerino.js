...
var CreatePoll = function (_React$Component) {
  ...
  function CreatePoll(props) {
    ...
    _this.state = { options: [], submitOptions: [] };
  ...
  _createClass(CreatePoll, [{
    ...
    value: function renderOption() {
      var randyKey = String(Math.floor(Math.random() * 1000) + Math.floor(Math.random() * 1000));
      var randyName = 'option' + randyKey;
      var optionState = this.state.options;
      optionState.push(React.createElement('input', { required: true, className: 'input__option', key: randyKey, 'data-value': this.state.value, name: randyName, type: 'text' }));
      this.setState({ options: optionState });
    }
  }, {
    key: 'handleSubmit',
    value: function handleSubmit() {
      var inputs = Array.from(document.getElementsByClassName('input__option'));
      console.log(inputs);
      var values = inputs.map(function (input) {
        return input.value;
      });
      var name = document.getElementById('poll-name').value;
    ...
    value: function render() {
      return React.createElement(
        'form',
        { onSubmit: this.handleSubmit, method: 'post', action: '/create-poll' },
        React.createElement(
          'p',
          null,
          'Create A Poll'
        ...
        React.createElement(
          ...
          null,
          'Name: ',
          React.createElement('input', { required: true, type: 'text', id: 'poll-name' })
        ),
        React.createElement('input', { required: true, className: 'input__option', type: 'text' }),
        this.state.options,
        React.createElement(
          'button',
          { className: 'create-poll__add-btn', onClick: this.renderOption },
          'Add Option'
        ),
